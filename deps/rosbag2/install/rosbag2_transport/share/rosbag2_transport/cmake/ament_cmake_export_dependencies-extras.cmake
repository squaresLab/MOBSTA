...
set(_exported_dependencies "keyboard_handler;rosbag2_cpp;rosbag2_compression;rosbag2_interfaces;shared_queues_vendor;yaml_cpp_vendor")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rosbag2_transport_INCLUDE_DIRS "${_include_dirs}")
          endif()

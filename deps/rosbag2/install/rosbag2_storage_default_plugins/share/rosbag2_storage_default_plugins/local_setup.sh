...
: ${AMENT_CURRENT_PREFIX:="/home/mobstauser/MOBSTA/deps/rosbag2/install/rosbag2_storage_default_plugins"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosbag2_storage_default_plugins/environment/library_path.sh"

...
set(_exported_dependencies "rosbag2_storage;rcpputils;rcutils;sqlite3_vendor;SQLite3")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rosbag2_storage_default_plugins_INCLUDE_DIRS "${_include_dirs}")
          endif()

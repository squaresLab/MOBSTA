...
#ifndef __GORGON_MUTATORS_NUMERICAL_ARRAYS_H__
#define __GORGON_MUTATORS_NUMERICAL_ARRAYS_H__

#include <random>
#include <cstdint>
#include "base.h"

namespace FixedSizeNumericalArray {
 ...
 */
template<typename T>
class FixedSizeNumericalArrayMutator : public BaseMutator
{
public:
    /**
     ...
     */ 
    FixedSizeNumericalArrayMutator(std::size_t arraySize);
 ...
 */
template<typename T>
class ReplaceWholeArrayMutator : public FixedSizeNumericalArrayMutator<T>
{
public:
 ...
 */
template<typename T>
class ProbabalisticReplaceMutator : public FixedSizeNumericalArrayMutator<T>
{
public:
 ...
 */
template<typename T>
class AddToWholeArrayMutator : public FixedSizeNumericalArrayMutator<T>
{
public:
    /**
...
}; // end namespace FixedSizeNumericalArray

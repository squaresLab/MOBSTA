...
if __name__ == "__main__":
    ...
    logging_dir = os.path.join(os.getenv("HOME"), "logs/ros1")
    ...
    recording_command_inputs = "rosbag record -o sensor_inputs --split -b 1024 --size 4096 /scan /tf_static /imu /sensor_state /joint_states /magnetic_field /odom /tf"
    recording_command_control_outputs = "rosbag record -o control_outputs --split -b 1024 --size 4096 /cmd_vel"

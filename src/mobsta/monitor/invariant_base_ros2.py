...
class BaseInvariantROS2(Node):
    ...
    def __init__(self):  # noqa: D107
        ...
        self._pub = self.create_publisher(KeyValue, BaseInvariantROS2.VIOLATIONS_TOPIC, 10)
    ...
    def get_params(self):
        ...
        returns:
            dict: json of invariant parameters loaded into a dict
    ...
    def report_violation(self):
        ...
        violation = KeyValue()
        violation.key = self.name
        violation.value = str(duration)
